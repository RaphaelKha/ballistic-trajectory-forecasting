...
> https://github.com/user-attachments/assets/e51d8afc-254c-4141-bda0-33e45940fbdb
...
```mermaid
graph TD
    A[Input: Absolute Sequence 30x2] --> B[Relative Centering: p_t - p_30]
    B --> C[Linear Projection Layer: 2 -> 256]
    C --> D[GRU Encoder Cell]
    D --> |Hidden State h_t| D
    D --> |Final Kinematic State h_30| E[Autoregressive Decoder]
    E --> F[Predict Delta 1]
    F --> G[Predict Delta 2]
    G --> H[...]
    H --> I[Predict Delta 30]
    I --> J[Absolute Re-anchoring]
    J --> K[Output: Future Trajectory 30x2]
    
    style A fill:#1e1e1e,stroke:#fff,color:#fff
    style K fill:#b91c1c,stroke:#fff,color:#fff
    style D fill:#0369a1,stroke:#fff,color:#fff
...
> (https://github.com/user-attachments/assets/f32a3b89-02a1-4912-a816-164cd364745d)
